...
## F1 — Add the playback-gate assertion (evals 1, 2; tighten eval 3) — HIGHEST PRIORITY
...
## F2 — Add the better-question-beat assertion (eval 2)
...
## F3 — Stop leading the witness (eval 2 prompt)
...
## F4 — Tighten the per-turn question cap (eval 1, assertion 2)
...
## F5 — Unify the jargon-gloss list (all evals)
...
## F6 — Grading operationalization note (evals/README.md, not evals.json)
...
## F7 — New eval 4: mid-session invocation (the triage opener's source 1)
...
## F8 — Fixture consistency repair (eval-2)
